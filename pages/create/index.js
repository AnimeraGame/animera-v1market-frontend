...
import MintWrapper from 'pageComponents/create/index'
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Mint NFT" />
        <meta name="twitter:title" content="Mint NFT" />
      </Head>
      <Container>
        <PageContent title="Mint NFT">
